    ...
    [PAGES.FOURTH]: [
      {
        ...
        fullData: {
          title: "Telegram бот - магазин цифровых товаров",
          description:
            "Бот показывает каталог цифровых товаров, принимает оплату, автоматически выдаёт ссылки или ключи после покупки и ведёт историю заказов в личном кабинете. Содержит адаптивную адинку на React для добавление товаров, управление ценами, аналитики.",
          stack: [
            "node.js, v18+",
            "telegraf.js",
            "PostgreSQL, v14+",
